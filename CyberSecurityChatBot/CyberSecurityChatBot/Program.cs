...
|____/ \___/ \__|____/ \__,_|_|  \___|                          
        ...
        static void AddTaskFlow()
        {
            ...
            if(rsp=="yes"||rsp=="y"){Console.Write("Enter reminder timeframe (e.g. 'in 3 days' or '2025-07-01'): ");var w=Console.ReadLine()?.Trim().ToLower()??"";var m=Regex.Match(w,@"in\s+(\d+)\s+days");
        ...
        {
            Console.WriteLine("\n Your current cybersecurity tasks:");
        ...
        static void DeleteTask(int i)
        {
            ...
            Console.ForegroundColor=ConsoleColor.Yellow;Console.WriteLine($"\n Deleted task '{t}'.");Console.ResetColor();
        }
